...
export default function Footer() {
  return (
    <footer className="relative border-t border-black/10 bg-white text-[var(--color-earth-dark)] overflow-hidden">
      <Leaf className="absolute -right-12 -top-12 h-48 w-48 text-[var(--color-leaf-soft)] rotate-12" />
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_1fr_1fr]">
          <div>
            <Link href="/" className="mb-5 flex items-center gap-3">
              ...
              <span>
                <span className="block font-playfair text-3xl font-semibold text-[var(--color-green-forest)]">
                  AL BARAKA
                </span>
            ...
            <p className="max-w-sm text-sm leading-7 text-[var(--color-earth-mid)]">
              Fresh from nature, delivered with care. Premium fruits and
              vegetables sourced through trusted farms, cold-chain handling, and
            ...
            <div className="mt-6 flex gap-3">
              <a
                href="#"
                aria-label="Facebook"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-green-forest)] text-white transition-transform hover:-translate-y-0.5"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
          ...
          <div>
            ...
            <div className="grid gap-3 text-sm text-[var(--color-earth-mid)]">
              ...
              <Link
                href="/products"
                className="hover:text-[var(--color-green-forest)]"
              >
                Products
              </Link>
              <Link
          ...
          <div>
            ...
            <div className="grid gap-4 text-sm text-[var(--color-earth-mid)]">
              <span className="flex gap-3">
                <Phone className="h-4 w-4 text-[var(--color-green-forest)]" />
                +20 100 123 4567
              </span>
              <span className="flex gap-3">
